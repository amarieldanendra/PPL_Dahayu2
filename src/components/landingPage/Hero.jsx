    ...
    return(
        ...
        >
            ...
            >
                ...
                <input placeholder="What are you looking for?" className="h-4/5 w-4/5 font-dosis text-xl bg-[#EFEFEF] outline-none border-none focus:outline-none focus:border-none focus-visible:outline-none focus-within:outline-none focus-visible:border-none focus-within:border-none text-[#023020]" type="text" name="search" id="search" />
            </div>
        </div>
    )
}